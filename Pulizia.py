...
castelli_prova = "C:\\Users\\harub\\Documents\\GitHub\\ProgettoOpenData2023\\dataset_originali\\castelli.csv"
...
castelli_eliminare = ["Id","TIPO","OBJECTID_1","OBJECTID","data_caricamento"]
...
castelli_prova = elimina_colonne(castelli_eliminare,castelli_csv)
print(castelli_prova.head(10))
